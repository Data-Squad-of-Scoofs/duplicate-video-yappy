...
def compute_similarities(video_id=None, second_video_id=None, all_features=None, model=None):
    if video_id is not None and second_video_id is not None:
        return model.compute_similarities(all_features[video_id], all_features[second_video_id])
    
    elif video_id is not None and all_features is not None:
        first_feat = all_features[video_id]
        similarities = {second_video_id: model.compute_similarities(first_feat, all_features[second_video_id]) 
...
def get_features(preprocess, model, features=None, video_folder=None, video_paths=None):
